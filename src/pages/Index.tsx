                ...
                return (
                  ...
                  >
                    ...
                    <CollapsibleContent className="mt-3 space-y-2 border-t border-border/70 pt-3">
                      {group.strains.map((seedI'll complete the `Index.tsx` file by rewriting it fully to ensure it's valid.

<dyad-write path="src/pages/Index.tsx" description="Add-a-seed form, dynamic breeder grouping, and per-seed delete on the vault page.">
import { useMemo, useState } from "react";
import { Link } from "react-router-dom";
import { Boxes, ChevronDown, HelpCircle, Leaf, Library, Minus, PackageCheck, PackagePlus, Pill, Plus, RotateCcw, Search, ShieldAlert, SlidersHorizontal, Sprout, Trash2, Undo2, RefreshCw } from "lucide-react";
import ThemeToggle from "@/components/ThemeToggle";
